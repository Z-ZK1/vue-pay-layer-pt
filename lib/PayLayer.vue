    ...
    <div class="safe-keyboard-layer"
      ...
      <div class="inner"
        ...
        <div class="both-center forget-btn-row"><span class="forget-btn"
                @click="forgetClickEvent">Esqueceu a Senha?</span></div>
        ...
        <div class="pay-fail"
          ...
          <div class="pay-fail-lay">
            ...
            <div class="btns">
              <div @click="resetInput">Entrar Novamente</div>
              <div @click="forgetClickEvent">Esqueceu a Senha?</div>
            </div>
          </div>
        </div>
      </div>
